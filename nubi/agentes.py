...
PERFIS = {
    ...
    "astra": {
        ...
        "pode": ["Especificar telas, layout e critérios de pronto", "Receber fotos e vídeos do Bruno na conversa direta",
                 ...
                 "Mandar o código dos cards para o Ferreiro, que programa na hora"],
        "nao_pode": ["Programar ou publicar ele mesmo (o Ferreiro programa, o Chefe revisa e publica)",
